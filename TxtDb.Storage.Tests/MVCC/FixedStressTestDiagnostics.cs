...
public class FixedStressTestDiagnostics : IDisposable
{
    ...
    public void FixedStressTest_HighConcurrency_MaintainsDataIntegrity()
    {
        ...
        Assert.True(successful > 10); // Some should succeed despite high contention
        Assert.True(conflicts > 100); // Many should conflict due to ForceOneObjectPerPage + high concurrency
