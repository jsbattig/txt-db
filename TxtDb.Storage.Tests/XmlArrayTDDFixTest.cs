...
public class XmlArrayTDDFixTest
{
    ...
    public void GREEN_XmlArrayRoundTrip_WithGenericSerialization_ShouldWork()
    {
        ...
        // The adapter will serialize using the concrete type, then deserialize correctly
        Assert.Contains("ArrayOfComplexArrayItem", serializedAsObjectArray);
        _output.WriteLine("GREEN PHASE COMPLETE: Adapter handles complex object array serialization works");
    }
    ...
    {
        // Use the adapter's SerializeArray method which handles complex types correctly
        // This is the proper approach - let the adapter handle the complexity
        return _adapter.SerializeArray(objects);
    }
}